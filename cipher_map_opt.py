...
def recall_password(cipher_grille, ciphered_password):
    ...
    should_rotate_to =    [(0,3),(1,3),(2,3),(3,3),
                       ...
                       (0,0),(1,0),(2,0),(3,0)]
'''
    ## This is an alternate solution given on checkio
    result = []
    for x in range(4):
        # this line I understand
        result += [ciphered_password[i][j] for i in range(4) for j in range(4) if cipher_grille[i][j] == 'X']
        #print result 
        #this line makes a new cipher grille for which the columns became rows
